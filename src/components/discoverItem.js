...
import { color, useColorMode } from "../constants";
...
const DiscoverItem = ({ item, navigation, DeleteProducts, refetch }) => {
  ...
  return (
    <View style={{ ...styles.container, backgroundColor: colors.body2 }}>
      <View style={{ ...styles.headerItem, backgroundColor: colors.body }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <ButtonC
            ...
            title={
              knitisloading ? "..." : item?.isKnigted ? "Unfollow" : "Follow"
            }
          />
      ...
      <ViewShot
        style={{ backgroundColor: colors.body, borderRadius: 10 }}
        ref={ref}
        ...
        <View style={{ width: "100%", aspectRatio: 1, position: "relative" }}>
          {learnMore && (
            <Animated.View style={{ ...styles.overLay, ...animatedStyle }}>
              <Text style={{ ...fonts.small, color: colors.textColor2 }}>
        ...
        <View style={{ ...styles.footerItem }}>
          <View style={{ maxWidth: "60%", padding: 3 }}>
            <View style={{ flexDirection: "row", alignItems: "center",marginBottom:9 }}>
              ...
              >
               Starting from N{item?.price ? numberWithCommas(item?.price) : "0.00"}
              </Text>
              {item?.stock == true ? (
                <Text
                  style={{
